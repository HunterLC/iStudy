...
public class EnglishCET4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewPager viewPager = (ViewPager) findViewById(R.id.english_view_pager);
        viewPager.setAdapter(new simpleAdapter(getSupportFragmentManager()));
        TabLayout tabLayout = (TabLayout) findViewById(R.id.english_tab_layout);
    ...
    public void initToolBar(){
        toolbar = (Toolbar)findViewById(R.id.english_toolbar);
        toolbar.setTitle("英语");
        toolbar.setNavigationIcon(R.drawable.qmui_icon_topbar_back);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(EnglishCET4Activity.this,"你在英语界面点击了返回",Toast.LENGTH_SHORT).show();
                startActivity(new Intent(EnglishCET4Activity.this,EnglishSearchActivity.class));
                finish();
            }
        });
    }
