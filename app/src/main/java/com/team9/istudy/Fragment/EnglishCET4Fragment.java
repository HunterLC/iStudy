    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null)
        {
            ...
            switch (currentPosition){
                case 0:
                    wordList = EnglishCET4Activity.myWordList1;//得到数据
                    break;
                case 1:
                    wordList = EnglishCET4Activity.myWordList2;//得到数据
                    break;
                case 2:
                    wordList = EnglishCET4Activity.myWordList3;//得到数据
                    break;
                case 3:
                    wordList = EnglishCET4Activity.myWordList4;//得到数据
                    break;
            }
        }
